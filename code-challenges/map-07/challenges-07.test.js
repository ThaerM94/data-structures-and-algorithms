...
Write a function named forLoopTwoToThe that, given an array of integers as input,
 iterates over the array and returns a new array. The returned array should contain the result of raising 
 2 to the power of the original input element.
...
const extractStats = (arr) => {
  let obj0 = arr.map(val => {
      let obj1 = Object.values(val);
      // [{url,nam},9,65]
      let sum = obj1[1]+obj1[2];
      let obj2 = Object.values(obj1[0]);
      //[url,nam]
     return  {
          name : obj2[1],
          total : sum
